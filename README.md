...
- 💪 **[Whoop Dashboard](https://github.com/georgenijo/whoop-dashboard)** — Recovery, sleep, strain, workouts in Next.js + SQLite. LLM coach with server-side data tools and full tool-use persistence.
...
- 🏠 **[homelab](https://github.com/georgenijo/homelab)** — Home Assistant stack: Govee BLE→MQTT bridge, SmartRent thermostat, Tapo cameras, SwiftUI HomeOS on TestFlight.
- ⛪ **[St-Basils-Rebuild](https://github.com/georgenijo/St-Basils-Rebuild)** — Next.js rebuild of [stbasilsboston.org](https://st-basils-rebuild.vercel.app/) — Sanity CMS, Supabase, member portal, event RSVP, newsletter.
...
- Whatever sounds fun that week — menu bar apps, agent tools, church websites, star maps
